...
class WidgetsTest extends Enlight_Components_Test_Controller_TestCase
{
    ...
    {
        $date = $this->getTurnOverVisitorsWindowStart();
    ...
    /**
     * Mirrors {@see Shopware_Controllers_Backend_Widgets::getTurnOverVisitorsAction()}.
     */
    private function getTurnOverVisitorsWindowStart(): DateTime
    {
