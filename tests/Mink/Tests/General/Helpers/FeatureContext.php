...
class FeatureContext extends SubContext implements SnippetAcceptingContext
{
    ...
    /**
     * Recover from a crashed browser and set a stable viewport. Selenium2 only.
     *
     * @BeforeScenario
     */
    public function setupBrowserSession(): void
    {
    ...
    public function saveScreenshot(?string $filename = null, ?string $filepath = null): void
    {
        ...
        try {
            ...
            // After a tab crash the WebDriver session is gone; do not mask the real failure.
        }
    }
